...
> On en redémarre pas la VM car on est actuellement connecté sur un système sur lequel on a la main. Si une erreur a été commise on risque de perdre complétement accès au système.
{.is-warning}
